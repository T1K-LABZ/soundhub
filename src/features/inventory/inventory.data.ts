...
export const STOCK_MOVEMENTS: StockMovement[] = [
  ...
  },
  {
    ...
    quantity: 5,
    reason: "Bulk order from Pioneer Kenya",
    staff: "Admin",
    runningBalance: 3,
    supplier: "Pioneer Kenya Ltd",
    expectedDate: "2026-06-12",
    trackingRef: "PO-2026-0089",
  },
  {
    id: "sm14",
    dateTime: "2026-06-04T16:30:00Z",
    productName: "JL Audio 4-Channel Amplifier XD400/4",
    brand: "JL Audio",
    serial: "JLA-XD400-4",
    category: "Amplifiers",
    movementType: "Incoming",
    quantity: 8,
    reason: "Restocking out-of-item item",
    staff: "Brian Mwangi",
    runningBalance: 0,
    supplier: "JL Audio Nairobi",
    expectedDate: "2026-06-10",
    trackingRef: "PO-2026-0088",
  },
];
